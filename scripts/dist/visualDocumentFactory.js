...
export function generateMockup(input) {
...
export function generateSopDocument(input) {
    const items = Array.isArray(input.workItems) ? normalizeItems(input.workItems) : [normalizeItem(input.workItem && typeof input.workItem === "object" ? input.workItem : input, 0)];
