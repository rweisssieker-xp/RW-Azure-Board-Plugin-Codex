...
export async function synthesizeReport(reportOrReports, options = {}) {
...
function buildFallbackSummary(reports, options) {
...
function buildPrompt(reports, options) {
...
function selectFindings(reports, maxFindings) {
    return reports
