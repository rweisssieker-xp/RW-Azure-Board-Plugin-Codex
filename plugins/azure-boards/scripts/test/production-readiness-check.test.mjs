...
test("production readiness gate reports only remaining hosted deployment placeholder failures", () => {
  ...
  for (const requiredPass of [
    ...
    "Submission includes azure_boards_product_outcome_proof_engine",
    "Submission includes azure_boards_product_decision_memory_learning",
    "Submission includes azure_boards_product_board_to_value_mapping",
    "Submission includes azure_boards_product_autonomous_governance_plan",
    "Submission includes azure_boards_product_compliance_evidence_score",
    "Submission includes azure_boards_product_scope_creep_radar",
    "Submission includes azure_boards_product_approval_simulation",
    "Submission includes azure_boards_product_executive_steering_room",
    "Submission includes azure_boards_product_decision_knowledge_graph",
    "Submission includes azure_boards_product_ai_readiness_prompt_governance",
    ...
    "outcomeProofEngine is implemented",
    "decisionMemoryLearning is implemented",
    "boardToValueMapping is implemented",
    "autonomousGovernanceOperatingPlan is implemented",
    "complianceEvidenceScore is implemented",
    "scopeCreepRadar is implemented",
    "approvalSimulation is implemented",
    "executiveSteeringRoom is implemented",
    "decisionKnowledgeGraph is implemented",
    "aiReadinessPromptGovernance is implemented",
